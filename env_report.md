# Environment Report — 2025-08-13T12:40:44

- CWD: `D:\projects\Thesis2025`
- Executable: `D:\projects\Thesis2025\.venv\Scripts\python.exe`
- Python: CPython 3.10.11 (64bit) on Windows 10 (AMD64)

## pip
- pip 25.2 from D:\projects\Thesis2025\.venv\lib\site-packages\pip (python 3.10)
- PIP_INDEX_URL: `<default>`
...
| 46%   47C    P8             42W /  370W |    1936MiB /  10240MiB |      3%      Default |
```
...
torchaudio: <not installed: No module named 'torchaudio'>
numpy: 1.26.4
pandas: 2.3.1
scipy: 1.15.3
matplotlib: 3.10.5
tqdm: 4.67.1
pyyaml: <not installed: No module named 'pyyaml'>
```